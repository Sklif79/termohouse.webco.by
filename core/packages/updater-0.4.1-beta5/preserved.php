<?php return array (
  ...
  '962bbeec28660e7e24ff1627abe0d937' => 
  array (
    'criteria' => 
    array (
    ...
    array (
      'id' => 15,
      'name' => 'Updater_SystemMaintenancePolicy',
      'description' => 'Policy for system maintenance tasks like showing updater widget and receiving notifications.',
      'parent' => 0,
      'template' => 10,
      'class' => '',
      'data' => '{"system_perform_maintenance_tasks":true,"system_receive_core_notifications":true,"system_receive_package_notifications":true}',
      'lexicon' => 'updater:permissions',
    ),
  ),
  '1db2d4c80675e633ee3e5c8e38534675' => 
  array (
    'criteria' => 
    array (
      'name' => 'Updater_SystemMaintenancePolicyTemplate',
    ),
    'object' => 
    array (
      'id' => 10,
      'template_group' => 1,
      'name' => 'Updater_SystemMaintenancePolicyTemplate',
      'description' => 'Policy template for system maintenance related tasks.',
      'lexicon' => 'updater:permissions',
    ),
  ),
  'c90892773b260344e904697d303e1a80' => 
  array (
    'criteria' => 
    array (
      'template' => 10,
      'name' => 'updater.system_perform_maintenance_tasks',
    ),
    'object' => 
    array (
      'id' => 235,
      'template' => 10,
      'name' => 'updater.system_perform_maintenance_tasks',
      'description' => 'updater.perm.system_perform_maintenance_tasks',
      'value' => 1,
    ),
  ),
  '60f309316c7c4eeeaff19ea75f9981bb' => 
  array (
    'criteria' => 
    array (
      'template' => 10,
      'name' => 'updater.system_receive_core_notifications',
    ),
    'object' => 
    array (
      'id' => 236,
      'template' => 10,
      'name' => 'updater.system_receive_core_notifications',
      'description' => 'updater.perm.system_receive_core_notifications',
      'value' => 1,
    ),
  ),
  '2ebdbc7c48cc533236f0eed44fd98285' => 
  array (
    'criteria' => 
    array (
      'template' => 10,
      'name' => 'updater.system_receive_package_notifications',
    ),
    'object' => 
    array (
      'id' => 237,
      'template' => 10,
      'name' => 'updater.system_receive_package_notifications',
      'description' => 'updater.perm.system_receive_package_notifications',
      'value' => 1,
    ),
  ),
  'f512dec79697206d8d2203af7c6342fc' => 
  array (
    'criteria' => 
    array (
      'key' => 'updater.mui_enable',
    ),
    'object' => 
    array (
      'key' => 'updater.mui_enable',
      ...
      'xtype' => 'combo-boolean',
      'namespace' => 'updater',
      'area' => '(9) Managed Update Information',
      'editedon' => NULL,
    ),
  ),
  '807a575ef456952d7da5b300b3090e3c' => 
  array (
    'criteria' => 
    array (
      'key' => 'updater.mui_url',
    ...
    array (
      'key' => 'updater.mui_url',
      'value' => 'https://updater.modx.seda.digital/modx.mui.json',
      'xtype' => 'textfield',
      'namespace' => 'updater',
      'area' => '(9) Managed Update Information',
      'editedon' => NULL,
